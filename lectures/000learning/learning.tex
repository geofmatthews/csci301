...
\bfr{The Pomodoro Technique}
\centerline{\includegraphics{pomodoro.jpg}}
\begin{enumerate}
\item Decide on a task to be done.
\item Set the pomodoro to 25 minutes.
\item Work on the task.
\item End work when the timer rings and put a checkmark on a piece of paper.
\item Take a short break (3-5 minutes).
\item After four pomodoros, take a longer break (15-30 minutes).
\end{enumerate}
